import { FileText, Settings2, Compass, FolderOpen, Cpu, Layers } from 'lucide-react';
...
const tabs: { id: MainTab; labelAr: string; icon: typeof FileText }[] = [
  ...
  { id: 'reports',  labelAr: 'التصميم', icon: FileText },
  { id: 'foundations', labelAr: 'الأساسات', icon: Layers },
];
